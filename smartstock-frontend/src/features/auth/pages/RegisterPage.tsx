    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-[400px]">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-section-title font-semibold text-gray-900">Create your account</h1>
          <p className="mt-1 text-body text-gray-600">Get started in less than a minute</p>
        </div>
