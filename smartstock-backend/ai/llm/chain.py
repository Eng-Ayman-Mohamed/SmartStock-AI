...
def _get_llm():
    """Lazy LLM initializer — defers API key validation to first use.

    Importing this module must not require OPENAI_API_KEY. The LLM client
    is constructed on demand the first time it is needed.
    """
