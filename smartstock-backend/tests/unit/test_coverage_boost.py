...
class ForecastingTasksTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.product = Product.objects.create(
            name='Task Product', category=cls.category, supplier=cls.supplier, safety_stock=5,
        )
...
class InventoryServiceMethodTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.product = Product.objects.create(
            name='Svc Product', category=cls.category, supplier=cls.supplier, safety_stock=5,
        )
    ...
    def test_create_supplier(self):
        from apps.inventory.services import InventoryService
        data = {'name': 'New Supplier', 'contact_email': 'new@supplier.com', 'default_lead_time_days': 5}
    ...
    def test_delete_supplier_no_open_pos(self):
        from apps.inventory.services import InventoryService
        s = Supplier.objects.create(name='Del', contact_email='del@sup.com', default_lead_time_days=1)
